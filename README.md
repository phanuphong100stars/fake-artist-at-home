# 🎨 ศิลปินจอมปลอม — Fake Artist

เกมปาร์ตี้แนว **Hidden Role + Drawing** เล่นด้วยมือถือเครื่องเดียว (Pass & Play) ภาษาไทย 100%

ศิลปินทุกคนได้ **คำจริง** เดียวกัน แต่มี **ตัวปลอม** แอบปนอยู่ ได้ **คำหลอกที่คล้ายกัน** ผลัดกันวาดคนละเส้นบนภาพเดียวกัน แล้วช่วยกันจับว่าใครคือตัวปลอม
...
**เงื่อนไขชนะ (มนุษย์ตัดสิน):** ศิลปินชนะถ้าจับตัวปลอมได้ · ตัวปลอมชนะถ้ารอด
