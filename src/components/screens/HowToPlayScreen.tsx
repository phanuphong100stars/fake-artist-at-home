...
const STEPS = [
  {
    ...
    body: "จิตรกรทุกคนเห็น “คำจริง” เดียวกัน แต่มี “ตัวปลอม” แอบปนอยู่ ได้คำหลอกที่คล้ายกัน (เช่น จริง=แมว หลอก=เสือ)",
  },
  {
    icon: Brush,
    title: "ผลัดกันวาดคนละเส้น",
    body: "วาดบนภาพเดียวกัน จิตรกรต้องวาดให้เพื่อนรู้ว่าตัวเองรู้คำ แต่อย่าชัดจนตัวปลอมเดาออก ส่วนตัวปลอมต้องเนียนให้ได้",
  },
  {
    icon: VenetianMask,
